...
var _initialiseProps = function _initialiseProps() {
	...
	this.updateDefaultQuery = function (queryOptions) {
		(0, _helper.updateInternalQuery)(_this3.internalComponent, queryOptions, Object.keys(_this3.state.currentValue), _this3.props, MultiDropdownList.generateQueryOptions(_this3.props, _this3.state.prevAfter, _this3.state.currentValue));
	};

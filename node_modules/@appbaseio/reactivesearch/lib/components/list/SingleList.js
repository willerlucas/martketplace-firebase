...
var _initialiseProps = function _initialiseProps() {
	...
	this.updateDefaultQuery = function (queryOptions) {
		(0, _helper.updateInternalQuery)(_this5.internalComponent, queryOptions, _this5.state.currentValue, _this5.props, SingleList.generateQueryOptions(_this5.props, _this5.state.prevAfter, _this5.state.currentValue));
	};

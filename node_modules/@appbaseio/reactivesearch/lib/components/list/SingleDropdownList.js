...
var _initialiseProps = function _initialiseProps() {
	...
	this.updateDefaultQuery = function (queryOptions) {
		(0, _helper.updateInternalQuery)(_this3.internalComponent, queryOptions, _this3.state.currentValue, _this3.props, SingleDropdownList.generateQueryOptions(_this3.props, _this3.state.prevAfter, _this3.state.currentValue));
	};
